...
export function registerAdaLanguage(monaco: typeof Monaco) {
  ...
  monaco.editor.defineTheme('ada-dark', {
    ...
    colors: {
      ...
      'editorWhitespace.foreground': '#1e2d45',
      'editorIndentGuide.background': '#1e2d45',
      'editorIndentGuide.activeBackground': '#2a3f5e',
      'editor.findMatchBackground': '#22d3ee44',
      'editor.findMatchHighlightBackground': '#22d3ee22',
      'editorGutter.background': '#0b0f1a',
      'scrollbarSlider.background': '#1e2d4588',
      'scrollbarSlider.hoverBackground': '#2a3f5eaa',
